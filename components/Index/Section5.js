  ...
  return (
    ...
    <div data-aos='fade' data-aos-duration='1000'>
      <section className='m-t-xs-20-xl-40 pos-relative text-center section-5'>
        <div className='container w3-card-4 p-0 banner item-1'>
        ...
        <div className='item-2'>
          <div className='container p-0'>
            ...
            >
              ...
              <h1 className='m-b-10 header-2 c-light'>{header}</h1>
              <p
                className='m-b-20 content-1 c-light'
                dangerouslySetInnerHTML={{ __html: content }}
              ></p>
              <div className='btn-container'>
                <Link href='/kastel'>
                  <button className='btn btn-light'>VIŠE</button>
                </Link>
              </div>
            </div>
            {/* </Fade> */}
